...
@section('title', "Edit Product — {$website->tld}")
...
@section('content')
<form action="{{ url("websites/{$website->id}/products/{$product->id}") }}" method="POST">
    @csrf
    @method('PUT')
        ...
        <div class="shadow-sm rounded-md overflow-hidden">
            <div class="p-4 bg-white">
                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="max-w-lg rounded-md shadow-sm sm:max-w-xs">
                            <input id="name" name="name" value="{{ old('name', $product->name) }}" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="max-w-lg rounded-md shadow-sm sm:max-w-xs">
                            <div class="border border-gray-300 rounded-md flex items-center">
                                ...
                                <input id="price" name="price" value="{{ old('price', $product->price) }}" class="form-input block flex-1 transition duration-150 ease-in-out sm:text-sm sm:leading-5 rounded-l-none border-0">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="mt-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="max-w-lg rounded-md shadow-sm sm:max-w-xs">
                            <input type="number" id="limit" name="limit" value="{{ old('limit', $product->limit) }}" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                        </div>
                    </div>
                </div>
                <div class="mt-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="max-w-lg rounded-md shadow-sm sm:max-w-xs">
                            <input type="duration" id="duration" name="duration" value="{{ old('duration', $product->duration) }}" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                        </div>
                    </div>
                </div>
                <div class="mt-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="max-w-lg rounded-md shadow-sm sm:max-w-xs">
                            <textarea rows="4" id="description" name="description" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5">{{ old('duration', $product->description) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
