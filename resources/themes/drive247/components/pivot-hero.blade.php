<div class="hero py-32 bg-gray-900 text-white relative">
    ...
    <div class="container relative">
        ...
        <a href="{{ $block->buttonHref ?? '/prices' }}" class="mt-8 text-xl text-white bg-red-700 rounded shadow-sm px-6 py-3 inline-block font-bold duration-300 transition-colors hover:bg-red-800">
