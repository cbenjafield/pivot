...
export default {
    ...
    methods: {
        ...
        createForm() {
            ...
            axios.post(`/websites/${this.website}/contact`, {
                title: this.title,
                email: this.email,
                ...
                if(response.status == 201) {
                    return window.location.href = response.data.redirect_url || `/websites/${this.website}/contact`;
                }
            }).catch(error => {
